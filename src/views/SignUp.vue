  ...
  <div class="container">
    ...
    <form @submit.prevent="signup">
      <div class="profilepic">
        <div class="image">
          <img :src="image" alt="profile picture" v-if="image">
        </div>
        <label for="img">
          <font-awesome-icon icon="upload" id="star" />
          Upload image
        </label>
        <input @change="onFileChange" type="file" ref="fileInput" id="img" name="img" accept="image/png, image/jpeg" class="inputfile">
      </div>
      <div class="nametext">
